...
#define KINETIS_MCG_FLL_DRS         1           /* 732x FLL factor */
...
#define KINETIS_CLKDIV1_OUTDIV2     1           /* Divide by 1 for (~24MHz) peripheral clock */
#define KINETIS_CLKDIV1_OUTDIV4     2           /* Divide by 2 for (~12MHz) flash clock */
